...
class MxGraph:
    ...
    def add_right_port(self, parent, label, offset_y, style={}):
    ...
    def add_left_port(self, parent, label, offset_y, style={}):
    ...
    def add_top_port(self, parent, label, offset_x, style={}):
    ...
    def add_bottom_port(self, parent, label, offset_x,style={}):
